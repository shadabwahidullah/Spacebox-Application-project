...
const NewIssue = () => {
  ...
  return (
    <div className="col mb-4">
      <form className="p-3 text-center bg-primary rounded py-2 g-2" onSubmit={(event) => { controlForm(event); }}>
        <h3 className="text-light">Create a new Issue</h3>
        <hr className="bg-light" />
        <input className="form-control" type="text-area" value={data.title} onChange={(e) => handle(e)} required placeholder="Describe the issue here" />
